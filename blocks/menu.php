...
<script type="text/javascript" src="jquery-slider-master/menu/ddsmoothmenu.js">
...
<li><a href="#"><?php echo $row_theloai['TenTL'] ?></a>
  ...
  ?>
  <li><a href="index.php?=tintrongloai&idLT=<?php echo $row_loaitin['idLT'] ?>"><?php echo $row_loaitin['Ten'] ?></a></li>
  <?php
  	}
  ?>
  </ul>
