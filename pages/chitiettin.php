...
?>
<h1 class="title"><?php echo $tin_row['TieuDe'] ?></h1>
<div class="des">
  <?php echo $tin_row['TomTat'] ?>
</div>
<div class="chitiet">
<!--noi dung-->

<?php echo $tin_row['Content'] ?>
...
<div class="number_count"><span id="like-total-1000000-3023795"><?php echo $tin_row['SoLanXem'] ?></span></div>
<!--face-->
...
<div class="clear"></div>
	<ul>
    	<?php 
        $idLT = $tin_row['idLT'];
        $tincungloai = TinCungLoaiTin($idTin,$idLT);
